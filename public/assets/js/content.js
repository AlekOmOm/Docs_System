export class ContentManager {
	constructor() {
		...
		this.backButton.textContent = 'Back to Graph';

		// Insert the button at the beginning of content div
		if (this.contentElement && this.markdownElement) {
			this.contentElement.insertBefore(this.backButton, this.markdownElement);
		}
